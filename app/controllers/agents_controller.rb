  ...
  private
    ...
    def agent_params
      params.require(:agent)
            .permit(:name, :docker_image, :docker_host, :workplace_path, :start_arguments, :continue_arguments, :volumes_config, :env_variables_json, :log_processor, :user_id, :instructions_mount_path, :home_path)
    end
